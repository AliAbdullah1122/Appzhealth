       ...
       <Tab.Screen
        ...
        options={{
          tabBarLabel: ({ focused }) => (
            ...
            >
              {capitalizeFirstLetter('appointments')}
            </Medium>
          ),
        }}
      />
       <Tab.Screen
        name="ImportPatientScreen"
        component={ImportPatientScreen}
        options={{
          tabBarLabel: ({ focused }) => (
            <Medium
              style={{
            ...
            >
              {capitalizeFirstLetter('import patient')}
            </Medium>
          ),
        }}
      />
       <Tab.Screen
        name="PatientSyncScreen"
        component={PatientSyncScreen}
        options={{
          tabBarLabel: ({ focused }) => (
            <Medium
              style={{
            ...
            >
              {capitalizeFirstLetter('patient sync')}
            </Medium>
          ),
        }}
      />
